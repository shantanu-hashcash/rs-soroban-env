...
//! is either a Hcnet `AccountID` or the `Hash` identity of some contract. But
...
//!
//!   2. The address of a Hcnet classic account, identified by `AccountID`,
...
//!
//!   3. The address of a Hcnet classic account that happens to be the
...
impl AuthorizationManager {
    ...
    pub(crate) fn push_frame(
        ...
        let (contract_id, function_name) = match frame {
            ...
            Frame::HcnetAssetContract(id, fn_name, ..) => (id.metered_clone(host)?, *fn_name),
