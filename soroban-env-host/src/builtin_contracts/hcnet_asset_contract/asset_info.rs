use crate::{
    builtin_contracts::hcnet_asset_contract::{
...
pub(crate) fn validate_asset(host: &Host, asset: &Asset) -> Result<(), HostError> {
    // This reimplements the Hcnet core `isAssetValid` function:
    // https://github.com/hcnet/hcnet-core/blob/372b4270166e7aad4b741500335b5394965b14a0/src/util/types.cpp#L147
