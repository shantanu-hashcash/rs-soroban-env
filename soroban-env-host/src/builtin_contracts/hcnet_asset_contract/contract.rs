...
pub(crate) struct HcnetAssetContract;
    ...
    pub(crate) fn init_asset(e: &Host, asset_bytes: BytesObject) -> Result<(), HostError> {
        ...
        if has_asset_info(e)? {
            return Err(e.error(
                ...
                "HcnetAssetContract has been already initialized",
                &[],
            ));
        }
        ...
        match asset {
            Asset::Native => {
                ...
                //No admin for the hcnet asset contract
            }
